...
![travis build fail](https://jonathonklem.com/assets/travis-screenshot.png)
...
![travis build success](https://jonathonklem.com/assets/travis-success.png)
