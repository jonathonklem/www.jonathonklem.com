...
?>gt;
&lt;Response&gt;
 &gt;Say voice="woman" loop="10">gt;The current temperature in Your room is <lt;?php echo $row['temperature']; ?>gt; degrees. The current date and time is <lt;?php echo date("F j, Y, g:i a", strtotime('+2 hours', time())); ?>gt;.<lt;/Say&gt;
&lt;/Response&gt;
```
